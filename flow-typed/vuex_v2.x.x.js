...
declare module 'vuex' {
  ...
  declare export function mapState<S>(map: Dictionary<(state: S, getters: any) => any>): Dictionary<() => any>;
  declare export function mapState<S>(namespace: string, map: Dictionary<(state: S, getters: any) => any>): Dictionary<() => any>;
