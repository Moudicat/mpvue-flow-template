...
declare type Vue$DirectiveFunction = (el: HTMLElement, binding: Vue$VNodeDirective, vnode: Vue$VNode, oldVnode: Vue$VNode) => void;
...
declare class Vue {
  ...
  $set: typeof Vue.set;
  $watch(expOrFn: string | Function, callback: Vue$WatchHandler, options?: Vue$WatchOptions): () => void;
  ...
  static directive(id: string, definition?: Vue$DirectiveOptions | Vue$DirectiveFunction): Vue$DirectiveOptions;
...
declare module 'vue' {
  ...
  declare type PluginObject<T> = any;
  declare type PluginFunction<T> = any;
